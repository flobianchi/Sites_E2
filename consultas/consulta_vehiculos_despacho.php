...
<body>
  ...
  $query = "SELECT DISTINCT * FROM Vehiculos, Despachos, Direcciones AS vdd WHERE id_direccion_destino = id_direccion and fecha LIKE ('%$ano%') and comuna LIKE LOWER ('%$comuna%')";
